                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="mb-4 form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Enter Email Address..." name="email">
                                        </div>
                                        <div class="form-group">
                                            <label for="password" class="hidden">Password</label>
                                            <input type="password" class="mb-4 form-control form-control-user"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="mb-4 btn btn-primary btn-user btn-block" type="submit" value="Log in" />
